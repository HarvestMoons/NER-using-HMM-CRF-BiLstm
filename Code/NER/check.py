...
if __name__ == "__main__":
    ...
    gold_file_path = os.path.join(base_path, 'example_data', 'train.txt')
    my_file_path=os.path.join(base_path, 'example_data', 'HMM_predict_validation.txt')

    check(language = "English", gold_path=gold_file_path, my_path=my_file_path)